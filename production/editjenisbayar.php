          ...
          <div class="col-sm-8 col-sm-offset-2">
            <form method="post">
              <div class="form-group">
                <h4><label>POS</label>
                    <select class="form-control" name="pos">
                      <option value="<?php echo $pecah['posbayar']; ?> "><?php echo $pecah['posbayar']; ?> </option>
                      <?php

                        $ambil=$koneksi->query("SELECT * FROM jenisbayar");
                        while($perkelas = $ambil -> fetch_assoc()){ ?>

                        <option value="<?php echo $perkelas['posbayar']; ?> "><?php echo $perkelas['posbayar']; ?> </option>
                        <?php } ?>
                    </select><h4>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ket" value="<?php echo $pecah['keteranganpos']; ?>"><h4>
              </div>

              <div class="form-group">
                <h4><label>Tipe Pembayaran</label>
                <input type="text" class="form-control" readonly name="tipe" value="<?php echo $pecah['tipebayar']; ?>"><h4>
              </div>
              ...
              <div class="form-group">
                  ...
                  <h4><label>Tahun Ajaran</label>
                    ...
                    <select class="form-control" name="tahunajaran">
                        <option value="<?php echo $pecah['tahunajaran']; ?> "><?php echo $pecah['tahunajaran']; ?> </option>
                    </select><h4>
              </div>
