...
 </head>
 <body>
  <CENTER><h4> SMK SARIPRAJA<br>JL. LEMPUNG PERDANA NO. 2, MANUKAN WETAN, TANDES, SURABAYA. TELP.(031)-7419719 <hr><STRONG>BUKTI PEMBAYARAN</STRONG><br>SPP Tahun : </h4></CENTER>
  <?php   
...
$ambil1=$koneksi->query("SELECT* FROM detail_tagihan_bulanan WHERE idTagihanBulanan='$_GET[id]'");
 ?>
     <tr> 
       <td align='center'><?php echo $tag['bulan'] ?></td>
       <td> </td>
       <td>  </td>
      </tr>		
      
