  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <h1> <i class="fa fa-ils"></i> <strong> Setting Tagihan </strong> </h1>
        </div>
        ...
        <div class="row">
          <div class="panel panel-primary">
            ...
            <div class="panel-heading">
              <h1 class="panel-title"><strong> Setting Tagihan </strong></h1>
            </div>

            <div class="panel-body">

              <h4>
                <table class="table table-bordered table-hover table-striped" id="datatabless">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>POS</th>
                      <th>Keterangan Pos</th>
                      <th>Tipe Bayar</th>
                      <th>Tahun Ajaran</th>
                  ...
                  <tbody>
                    ...
                    <?php $nomor=1; ?>
                    <?php  $ambil = $koneksi->query("SELECT * FROM jenisbayar"); ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $pecah['keteranganpos']; ?>
                      </td>
                      <td>
                        <?php echo $pecah['tipebayar']; ?>
                      </td>
                      <td>
                        <?php echo $pecah['tahunajaran']; ?>
                      </td>
                      <td><a href="settarif.php?&id=<?php echo $pecah['idjenisbayar'] ?>&tipe=<?php echo $pecah['tipebayar'] ?> "
                          class="btn btn-dark">Setting Tarif</a></td>
                      <td>
                        <a href="editjenisbayar.php?&id=<?php echo $pecah['idjenisbayar'] ?>" class="btn btn-primary btn-xs"><i
                            class="fa fa-edit"></i></a>
                        <a href="hapusjenisbayar.php?&id=<?php echo $pecah['idjenisbayar'] ?>" class="btn btn-danger btn-xs"><i
                            class="glyphicon glyphicon-erase"></i></a>
                      </td>
                    </tr>
                    <?php $nomor++; ?>
                    <?php } ?>
              ...
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="#tambah"><i class="glyphicon glyphicon-plus"></i>
                Tambah Data</button>
                  ...
                  <div class="modal-content">
                    ...
                    <form method="post">
                      <div class="modal-body">
                        <div class="form-group">
                          <label class="control-label" for="nama">POS</label>

                          <select class="form-control" name="pos" required="">


                            <?php
                               $ambil=$koneksi->query("SELECT * FROM posbayar");
                              while($kelas = $ambil -> fetch_assoc()){ ?>

                            <option value="<?php echo $kelas['nama'] ?>">
                              <?php echo $kelas['nama'] ?>
                            </option>
                        ...
                        <div class="form-group">
                          <label class="control-label" for="nama">Tipe Bayar</label>

                          <select class="form-control" name="tipebayarr" required="">

                            <?php
                               $ambil=$koneksi->query("SELECT * FROM tipebayar");
                              while($kelas = $ambil -> fetch_assoc()){ ?>

                            <option value="<?php echo $kelas['namatipebayar'] ?>">
                              <?php echo $kelas['namatipebayar'] ?>
                            </option>
                        ...
                        <div class="form-group">
                          <label class="control-label" for="nama">Tahun Ajaran</label>
                          ...
                          <select class="form-control" name="tipe" required="">
                            ...
                            <option value="<?php echo $kelas['tahunajaran'] ?>">
                              <?php echo $kelas['tahunajaran'] ?>
                            </option>
                    ...
                    <?php
                      if(isset($_POST['simpan'])){
                        $koneksi->query("INSERT INTO jenisbayar (posbayar,keteranganpos,tipebayar,tahunajaran)
                        VALUES('$_POST[pos]','$_POST[ket]','$_POST[tipebayarr]','$_POST[tipe]')");
