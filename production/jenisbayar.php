            ...
            <thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $pecah['posbayar']; ?></td>
                  <td><?php echo $pecah['keteranganpos']; ?></td>
                  <td><?php echo $pecah['tipebayar']; ?> </td>
                  <td><?php echo $pecah['tahunajaran']; ?> </td>
                  <td><a href="settarif.php?&id=<?php echo $pecah['idjenisbayar'] ?>&tipe=<?php echo $pecah['tipebayar'] ?> " class="btn btn-dark">Setting Tarif</a></td>
                  <td>
                    <a href="editjenisbayar.php?&id=<?php echo $pecah['idjenisbayar'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                    <a href="hapusjenisbayar.php?&id=<?php echo $pecah['idjenisbayar'] ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-erase"></i></a>
                  </td>
                </tr>
                <?php $nomor++; ?>
                <?php } ?>
                      ...
                      <div class="form-group">
                        <label class="control-label" for="nama">Tipe Bayar</label>
                         ...
                         <select class="form-control" name="tipebayarr" required="">
                            ...
                            <option value="<?php echo $kelas['namatipebayar'] ?>"><?php echo $kelas['namatipebayar'] ?></option>
