      ...
      if (mysqli_num_rows($query2)) {
        ...
        $check = 'check_'.$pecah['nis'];
          if(isset($_POST[$check])){
            $nis = $pecah['nis'];
            mysqli_query($koneksi, "UPDATE siswa SET status = 'Lulus' WHERE nis = $nis");
            echo "<script>alert('Siswa Berhasil Di Luluskan');</script>";
          }
        }
      }
    }
  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <h1> <i class="fa fa-graduation-cap"></i> <strong> Kelulusan </strong> </h1>
        </div>
          ...
          <div class="col-md-6">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong> Kelulusan </strong></h1>
              </div>
                  ...
                  <div class="col-md-offset-5">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        ...
                        <li><a href="katkelulusan.php?katkelas=<?php echo $kel[" namakelas"] ?>">
                            <?php  echo $kel["namakelas"]; ?></a></li>
                        <?php } ?>
                        <?php } ?>
                      </ul>
                    </div>
          ...
          <div class="col-md-6">
            <div class="panel-body">
              <div class="alert alert-warning">
                <h4>Warning!... !<br>
                  Halaman ini digunakan untuk merubah status siswa menjadi lulus. Pastikan siswa yang di proses adalah
                  siswa kelas XII!</h4>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <a href="kelulusan.php" class="btn btn-danger"><i class="fa fa-share"></i> Semua Kelas</a>
          <div class="panel panel-danger">
            <div class="panel-heading">

              <h1 class="panel-title"><strong> Pilih Siswa Yang Akan Di Proses (Kelas
                  <?php  echo $_GET["katkelas"]; ?>) </strong></h1>
            ...
            <div class="panel-body">
              <form method="post">
                ...
                <div class="text-center">
                  <button class="btn btn-danger" name="pindahh">Proses Lulus</button>
                </div>
