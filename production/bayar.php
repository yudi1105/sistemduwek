                          ...
                          <div class="panel-body">
                           <table class="table table-striped">
                             <tr>
                               ...
                               <td width="4px">:</td>
                               <td><?php echo $tag['keteranganpos']; ?></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                               ...
                               <td width="4px">:</td>
                               <td><?php echo $tag['nis']; ?></td>
                             </tr>
                             <tr>
                               <td width="100px">NISN</td>
                               <td width="4px">:</td>
                               <td><?php echo $tag['nisn']; ?></td>
                             </tr>
                             <tr>
                               <td width="100px">Nama Siswa</td>
                               <td width="4px">:</td>
                               <td><?php echo $tag['namasiswa']; ?></td>
                             </tr>
                             <tr>
                               <td width="100px">Kelas</td>
                               <td width="4px">:</td>
                               <td><?php echo $tag['kelas'] ?></td>
                             </tr>
                             <tr>
                           ...
                           <a href="pembayaransiswa.php" class="pull-right btn btn-primary"><i class="fa fa-share"></i> Kembali</a>               
                            </div>
                           ...
                           $ambil1=$koneksi->query("SELECT * FROM detail_tagihan_bulanan WHERE idTagihanBulanan=$_GET[tagihanbulanan]");
                            ...
                            <?php while($det = $ambil1->fetch_assoc()){
                              ...
                              ?>
                                ...
                                <tr>
                                  <td><?php echo $no; ?></td>
                                  <td><?php echo $det['bulan']; ?></td>
                                  <td>Rp.<?php echo number_format($det['nominal']); ?></td>
                                  <td><?php echo $det['status']; ?></td>
                                  <td align="center">
                                    <?php if($det['status'] == 'BELUM LUNAS'){ ?>
                                       <a class="btn btn-success btn-xs" href="prosestransaksi.php?&id=<?php echo $det['idDetailTagihanBulanan']?>&act=bayar&idtagihan=<?php echo $_GET['tagihanbulanan']?>"><span class="fa fa-check"></span></a>                                    <?php }else{ ?>
