          ...
          <div class="col-sm-8 col-sm-offset-2">
            <form method="post">
              <div class="form-group">
                <h4><label>NIS</label>
                <input type="number" class="form-control"  name="nis" value="<?php echo $pecah['nis']; ?>"><h4>
              </div>
              <div class="form-group">
                <h4><label>NISN</label>
                <input type="number" class="form-control" name="nisn" value="<?php echo $pecah['nisn']; ?>"><h4>
              </div>
              <div class="form-group">
                <h4><label>Nama</label>
                <input type="text" class="form-control" name="nama" value="<?php echo $pecah['namasiswa']; ?>"><h4>
              </div>
              <div class="form-group">
                  <h4><label>Kelamin</label>
                                
                    <select class="form-control" name="status">
                        <option value="<?php echo $pecah['jeniskelamin']; ?> "><?php echo $pecah['jeniskelamin']; ?> </option>
              ...
              <div>
                ...
                <input type="text" class="form-control" name="alamat" value="<?php echo $pecah['alamat']; ?>"><h4>
              </div>
              <div>
                <h4><label>Agama</label>
                <input type="text" class="form-control" name="agama" value="<?php echo $pecah['agama']; ?>"><h4>
              </div>
              <div class="form-group">
                  <h4><label>Kelas</label>
                                
                    <select class="form-control" name="kelas">
                      <option value="<?php echo $pecah['kelas']; ?> "><?php echo $pecah['kelas']; ?> </option>
                      <?php
               ...
               <div class="form-group">
                  <h4><label>Status</label>
                    ...
                    <select class="form-control" name="statussiswa">
                        <option value="<?php echo $pecah['status']; ?> "><?php echo $pecah['status']; ?> </option>
