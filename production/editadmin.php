    ...
    <div class="container body">
      <div class="main_container">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/user.png" alt=""> <?php echo $_SESSION["admin"]["namaadmin"] ?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="fa fa-edit"></i> <strong> Edit Admin </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong>Edit Admin</strong></h1>
              </div>
              ...
              <div class="panel-body">
                ...
                <div class="col-sm-8 col-sm-offset-2">
                  <form method="post">
                    <div class="form-group">
                      <h4><label>ID</label>
                      <input type="number" class="form-control" name="id" value="<?php echo $pecah['idadmin']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>Nama</label>
                      <input type="text" class="form-control" name="nama" value="<?php echo $pecah['namaadmin']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>Email</label>
                      <input type="email" class="form-control" name="email" value="<?php echo $pecah['emailadmin']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>Password</label>
                      <input type="text" class="form-control" name="password" value="<?php echo $pecah['passwordadmin']; ?>"></h4>
                    </div>
                ...
                <?php
                    if(isset($_POST['ubah'])){
                      $koneksi->query("UPDATE admin SET idadmin='$_POST[id]',
