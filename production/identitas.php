    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1><i class="fa fa-university"></i> Identitas Sekolah </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
               <div class="panel-title">Identitas Sekolah</div>
              </div>

              <div class="panel-body">
                <?php
                  $ambil = $koneksi->query("SELECT * FROM identitas");
                ...
                <div class="col-sm-8 col-sm-offset-2">
                  ...
                  <form method="post">
                    <div class="form-group">
                      <h4><label>Nama</label>
                      <input type="text" class="form-control" name="nama" value="<?php echo $pecah['namasekolah']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>Alamat</label>
                      <input type="text" class="form-control" name="alamat" value="<?php echo $pecah['alamatsekolah']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>NIP. Kepsek</label>
                      <input type="text" class="form-control" name="nipkep" value="<?php echo $pecah['nipkepsek']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>Nama Kepsek</label>
                      <input type="text" class="form-control" name="namakep" value="<?php echo $pecah['namakepsek']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>NIP. TU</label>
                      <input type="text" class="form-control" name="niptu" value="<?php echo $pecah['nipkepsek']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>Nama TU</label>
                      <input type="text" class="form-control" name="namatu" value="<?php echo $pecah['namatu']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>NIP. Bendahara</label>
                      <input type="text" class="form-control" name="nipben" value="<?php echo $pecah['nipbendahara']; ?>"></h4>
                    </div>
                    <div class="form-group">
                      <h4><label>Nama Bendahara</label>
                      <input type="text" class="form-control" name="namaben" value="<?php echo $pecah['namabendahara']; ?>"></h4>
                    </div>
                    <button class="btn btn-dark" name="ubah"><i class="fa fa-edit"></i> Ubah</button>
                     <a href="index.php" class="btn btn-default"><i class="fa fa-share"></i> Kembali</a>
                  </form>

                  <strong><p>*Setelah di ubah maka anda akan Log out, dan silahkan Log in Kembali</p></strong>
            


                <?php
                    if(isset($_POST['ubah'])){
                      $koneksi->query("UPDATE identitas SET namasekolah='$_POST[nama]',
                                                            alamatsekolah='$_POST[alamat]',
                                                            nipkepsek='$_POST[nipkep]',
                                                            namakepsek='$_POST[namakep]',
                                                            niptu='$_POST[niptu]',
                                                            namatu='$_POST[namatu]',
                                                            nipbendahara='$_POST[nipben]' ,
                                                            namabendahara='$_POST[namaben]'   
