            ...
            <div class="row">
              <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                   <h1 class="panel-title"><strong> Menambah Tarif / Tagihan Bulanan Siswa Per Kelas </strong></h1>
                </div>
                        ...
                        <div class="panel panel-danger">
                          ...
                          <div class="panel-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="jenisbayar" readonly class="form-control" value="<?php echo $pecah['keteranganpos'] ?>">
                              </div>
                              <div class="form-group">
                                <label>Tahun</label>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="tipebayar" readonly class="form-control" value="<?php echo $pecah['tipebayar'] ?>">
                              </div>
                              <div class="form-group">
                          ...
                          <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                  ...
                                  <div class="col-sm-4">
                                    <button class="btn btn-warning" name="terapkan"> Terapkan </button>
                          ...
                          <div class="panel-body">
                              ...
                              <table class="table">
                                <tbody>
                                  <tr>
                                    <td>Juli</td>
                                    <td><input type="number" name="b7" class="form-control" value="<?php echo $alltarif ?>"></td>
                              
                                    <td>Januari</td>
                                    <td><input type="number" name="b1" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  </tr>
                                  <tr>
                                    <td>Agustus</td>
                                    <td><input type="number" name="b8" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  
                                    <td>Februari</td>
                                    <td><input type="number" name="b2" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  </tr>
                                  <tr>
                                    <td>September</td>
                                    <td><input type="number" name="b9" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  
                                    <td>Maret</td>
                                    <td><input type="number" name="b3" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  </tr>
                                  <tr>
                                    <td>Oktober</td>
                                    <td><input type="number" name="b10" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  
                                    <td>April</td>
                                    <td><input type="number" name="b4" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  </tr>
                                  <tr>
                                    <td>November</td>
                                    <td><input type="number" name="b11" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  
                                    <td>Mei</td>
                                    <td><input type="number" name="b5" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  </tr>
                                  <tr>
                                    <td>Desember</td>
                                    <td><input type="number" name="b12" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  
                                    <td>Juni</td>
                                    <td><input type="number" name="b6" class="form-control" value="<?php echo $alltarif ?>"></td>
                                  </tr>
                                  <tr>
                                  </tr>
                                </tbody>
                              ...
                              <button type="submit" class="btn btn-success" name="simpan"><i class="fa fa-edit"></i> Simpan Tarif</button>
                                     <a href="jenisbayar.php" class="btn btn-default"><i class="fa fa-share"></i> Kembali</a>
