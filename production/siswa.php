    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="fa fa-users"></i> <strong> Pengelolaan Siswa </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong> Siswa </strong></h1>
              </div>
            ...
            <thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="editsiswa.php?&nis=<?php echo $pecah['nis'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                    <a href="hapussiswa.php?&nis=<?php echo $pecah['nis'] ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-erase"></i></a>
                  </td>
                </tr>
                <?php $nomor++; ?>
                <?php } ?>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><strong>Tambah Siswa</strong></h4>
                  </div>
                  <form method="post">
                    <div class="modal-body">
                      <div class="form-group">
                        <label class="control-label" for="nama">NIS</label>
                        <input type="text" name="nis" class="form-control" id="namakelas" required="" autocomplete="off">
                      </div>
                      <div class="form-group">
                        <label class="control-label" for="nisn">NISN</label>
                        <input type="text" name="nisn" class="form-control" id="ket" required="">
                      </div>
                      <div class="form-group">
                        <label class="control-label" for="nisn">Nama</label>
                        <input type="text" name="nama" class="form-control" id="ket" required="">
                      </div>
                      <div class="form-group">
                        <label class="control-label" for="nisn">Kelamin</label>
                      ...
                      <div class="form-group">
                        <label class="control-label" for="nisn">Alamat</label>
                        <input type="text" name="alamat" class="form-control" id="ket" required="">
                      </div>
                      <div class="form-group">
                        <label class="control-label" for="nisn">Agama</label>
                        <input type="text" name="agama" class="form-control" id="ket" required="">
                      </div>



                       <div class="form-group">
                        <label class="control-label" for="nisn">Kelas</label>
                          ...
                          <select class="form-control" name="kelas" required="">
                            ...
                            <option value="<?php echo $kelas['namakelas'] ?>"><?php echo $kelas['namakelas'] ?></option>
                      ...
                      <div class="form-group">
                        <label class="control-label" for="nisn">Status</label>
                              
                          <select class="form-control" name="statussiswa" required="">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" class="btn btn-success" name="simpann" value="simpan">Simpan</button>
                    </div>
                  </form>
                    <?php
                      if(isset($_POST['simpann'])){
                        $koneksi->query("INSERT INTO siswa (nis,nisn,namasiswa,jeniskelamin,alamat,agama,kelas,status)
                        VALUES('$_POST[nis]','$_POST[nisn]','$_POST[nama]','$_POST[status]','$_POST[alamat]','$_POST[agama]','$_POST[kelas]','$_POST[statussiswa]')");
