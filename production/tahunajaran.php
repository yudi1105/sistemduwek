    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="fa fa-calendar"></i> <strong> Tahun Ajaran </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong> Tahun Ajaran </strong></h1>
              </div>
            ...
            <thead>
              ...
              <tbody>
                ...
                <?php $nomor=1; ?>
                <?php  $ambil = $koneksi->query("SELECT * FROM tahunajaran"); ?>
                <?php  while($pecah = $ambil -> fetch_assoc()) { ?>
                <tr>
                  <td><?php echo $nomor; ?></td>
                  <td><?php echo $pecah['tahunajaran']; ?></td>
                  <td>
                    <a href="edittahunajaran.php?&id=<?php echo $pecah['idtahunajaran'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                    <a href="hapustahunajaran.php?&id=<?php echo $pecah['idtahunajaran'] ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-erase"></i></a>
                  </td>
                </tr>
                <?php $nomor++; ?>
                <?php } ?>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><strong>Tambah Tahun Ajaran</strong></h4>
                  </div>
                  <form method="post">
                    ...
                    <?php
                      if(isset($_POST['simpan'])){
                        $koneksi->query("INSERT INTO tahunajaran (tahunajaran)
                        VALUES('$_POST[nama]')");
