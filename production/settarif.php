    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="fa fa-gg-circle"></i> <strong> Setting Tagihan </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                 ...
                 <div class="row">
                    <div class="col-md-6">
                      <h3>Tarif - <?php echo $pecah['keteranganpos'];  ?> </h3><br>
                    
                      <h3><strong>Tahun </strong></h3><input type="text"  readonly value="<?php echo $pecah['tahunajaran'] ?>" class="form-control">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <h3><strong>Aksi </strong></h3>
                      <a href="settingtarif.php?&id=<?php echo $pecah['idjenisbayar']; ?>&tipe=<?php echo $pecah['tipebayar'] ?>" class="btn btn-dark"><i class="fa fa-plus"></i> Tambah</a>
