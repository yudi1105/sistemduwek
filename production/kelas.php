    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="glyphicon glyphicon-blackboard"></i> <strong> Pengelolaan Kelas </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong> Kelas </strong></h1>
              </div>
            ...
            <thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $pecah['idkelas']; ?></td>
                  <td><?php echo $pecah['namakelas']; ?></td>
                  <td><?php echo $pecah['keterangan']; ?> </td>
                  <td>
                    <a href="editkelas.php?&id=<?php echo $pecah['idkelas'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                    <a href="hapuskelas.php?&id=<?php echo $pecah['idkelas'] ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-erase"></i></a>
                  </td>
                </tr>
                <?php $nomor++; ?>
                <?php } ?>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><strong>Tambah Kelas</strong></h4>
                  </div>
                  <form method="post">
                    ...
                    <?php
                      if(isset($_POST['simpan'])){
                        $koneksi->query("INSERT INTO kelas (namakelas,keterangan)
