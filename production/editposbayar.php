    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="fa fa-edit"></i> <strong> Edit Pos Bayar </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong> Edit Pos Bayar </strong></h1>
              </div>

              <div class="panel-body">
              
                  <?php
                   $ambil = $koneksi->query("SELECT * FROM posbayar WHERE idposbayar='$_GET[id]'");
          ...
          <div class="col-sm-8 col-sm-offset-2">
            <form method="post">
              <div class="form-group">
                <h4><label>Nama</label>
                <input type="text" class="form-control" name="nama" value="<?php echo $pecah['nama']; ?>"><h4>
              </div>
             
              <button class="btn btn-dark" name="ubah"><i class="fa fa-edit"></i> Ubah</button>
              <a href="posbayar.php" class="btn btn-default"><i class="fa fa-share"></i> Cancel</a>
            </form>

            <?php
                if(isset($_POST['ubah'])){
                  $koneksi->query("UPDATE posbayar SET nama='$_POST[nama]' WHERE idposbayar='$_GET[id]'");
