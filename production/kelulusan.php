                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">  
                              ...
                              <?php if (mysqli_num_rows($query)) { ?>
                                  <?php   while ($kel = mysqli_fetch_array($query)) { ?>
                                      <li><a href="katkelulusan.php?katkelas=<?php echo $kel["namakelas"] ?>"><?php  echo $kel["namakelas"]; ?></a></li>
                                 <?php } ?>
                              <?php } ?>
                          </ul>
                        </div>
            ...
            <div class="col-md-6">
                <div class="panel-body">
                    <div class="alert alert-warning">
                      <h4>Warning!... !<br>
                      Halaman ini digunakan untuk merubah status siswa menjadi lulus. Pastikan siswa yang di proses adalah siswa kelas XII!</h4>
                    </div>
                  </div>
            </div>
          ...
          <div class="row">
            <div class="panel panel-danger">
              <div class="panel-heading">
                   ...
                   <h1 class="panel-title"><strong> Pilih Siswa Yang Akan Di Proses (Tampilan Semua Kelas) </strong></h1>
              ...
              <div class="panel-body">
                ...
                <thead>
                  ...
                  <tbody>
                    ...
                    <?php $nomor=1; ?>
                    <?php  $query2 =  mysqli_query($koneksi, "SELECT * FROM siswa") ?>
