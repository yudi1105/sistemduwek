    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="fa fa-home"></i> <strong> Home </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong>SISTEM INFORMASI KEUANGAN</strong></h1>
              </div>

              <div class="panel-body">
                <div class="alert alert-info">
                  <h3> Ini adalah halaman Dashboard yang digunakan untuk mengelola Pembayaran Sekolah, ditampilkannya halaman ini adalah bukti bahwa anda adalah pengguna resmi aplikasi ini.
                  Silahkan digunakan dengan baik, dan sampaikan jika ada keluhan dalam masalah penggunaan aplikasi ini. Terima kasih atas kepercayaan anda!</h3>
                </div>
              </div>
