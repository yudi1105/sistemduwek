              ...
              <div class="col-sm-8 col-sm-offset-2">
                <form method="post">
                  <div class="form-group">
                    <h4><label>ID</label>
                      <input type="number" class="form-control" readonly name="id" value="<?php echo $pecah['idkelas']; ?>">
                      <h4>
                  </div>
                  <div class="form-group">
                    <h4><label>Nama</label>
                      <input type="text" class="form-control" name="nama" value="<?php echo $pecah['namakelas']; ?>">
                      <h4>
                  </div>
                  <div class="form-group">
