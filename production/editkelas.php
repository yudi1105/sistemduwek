    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <h1> <i class="fa fa-edit"></i> <strong> Edit Kelas </strong> </h1>
          </div>
          ...
          <div class="row">
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <h1 class="panel-title"><strong> Edit Kelas </strong></h1>
              </div>

              <div class="panel-body">
              
                <?php
                  $ambil = $koneksi->query("SELECT * FROM kelas WHERE idkelas='$_GET[id]'");
          ...
          <div class="col-sm-8 col-sm-offset-2">
            <form method="post">
              <div class="form-group">
                <h4><label>ID</label>
                <input type="number" class="form-control" readonly name="id" value="<?php echo $pecah['idkelas']; ?>"><h4>
              </div>
              <div class="form-group">
                <h4><label>Nama</label>
                <input type="text" class="form-control" name="nama" value="<?php echo $pecah['namakelas']; ?>"><h4>
              </div>
              <div class="form-group">
                <h4><label>Keterangan</label>
                <input type="text" class="form-control" name="ket" value="<?php echo $pecah['keterangan']; ?>"><h4>
              </div>

              <button class="btn btn-dark" name="ubah"><i class="fa fa-edit"></i> Ubah</button>
              <a href="kelas.php" class="btn btn-default"><i class="fa fa-share"></i> Kembali</a>
            </form>

            <?php
                if(isset($_POST['ubah'])){
                  $koneksi->query("UPDATE kelas SET namakelas='$_POST[nama]',keterangan='$_POST[ket]' WHERE idkelas='$_GET[id]'");
